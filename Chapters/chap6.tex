...
\begin{figure}[h]
\centering
\includegraphics[width=0.4\textwidth]{Images/shunt.PNG}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{Images/ammetervoltmeter.PNG}
\end{figure}
...
\section{Summary of Direct-Current Circuits}
\begin{enumerate}
